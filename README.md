...
### TableData
The `TableData` class handles a lot of the work such as paging (`next`, `previous`, `first`, `last`, `sizeChange`) and sorting events. It also keeps the current state of the table including sorting and pagination.
...
<mat-paginator [pageSize]="table.pageSize" [pageIndex]="table.pageIndex" [pageSizeOptions]="table.pageSizeOptions" showFirstLastButtons
